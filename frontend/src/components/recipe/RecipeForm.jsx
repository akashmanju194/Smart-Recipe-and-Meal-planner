  ...
  return (
    <form className="recipe-form" onSubmit={handleSubmit}>
      ...
      <div className="form-row">
        <div className="form-group">
          <label htmlFor="recipe-time">Cooking Time (m)</label>
      ...
      <div className="form-row" style={{ gridTemplateColumns: '1fr 1fr 1fr' }}>
        <div className="form-group">
          ...
          <input id="recipe-protein" type="number" value={formData.protein} onChange={(e) => updateField("protein", e.target.value)} min="0" />
        </div>
        <div className="form-group">
          <label htmlFor="recipe-carbs">Carbs (g)</label>
          <input id="recipe-carbs" type="number" value={formData.carbs} onChange={(e) => updateField("carbs", e.target.value)} min="0" />
        </div>
        <div className="form-group">
          <label htmlFor="recipe-fats">Fats (g)</label>
          <input id="recipe-fats" type="number" value={formData.fats} onChange={(e) => updateField("fats", e.target.value)} min="0" />
        </div>
      </div>
